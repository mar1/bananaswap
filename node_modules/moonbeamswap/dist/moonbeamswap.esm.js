...
var WETH = "0xD909178CC99d318e4D46e7E66a972955859670E1";
var factory = "0xd15754c4cbed8e5E0b427ABB95b4D61D2B236C03";
...
(function (ChainId) {
  ...
  ChainId[ChainId["STANDALONE"] = 1281] = "STANDALONE";
  ChainId[ChainId["MOONROCK"] = 1286] = "MOONROCK";
  ChainId[ChainId["MOONBASE"] = 1287] = "MOONBASE";
  ChainId[ChainId["MOONSHADOW"] = 1288] = "MOONSHADOW";
})(ChainId || (ChainId = {}));
...
var FACTORY_ADDRESS = (_FACTORY_ADDRESS = {}, _FACTORY_ADDRESS[ChainId.STANDALONE] = '0x5c4242beB94dE30b922f57241f1D02f36e906915', _FACTORY_ADDRESS[ChainId.MOONROCK] = factory, _FACTORY_ADDRESS[ChainId.MOONBASE] = factory, _FACTORY_ADDRESS[ChainId.MOONSHADOW] = factory, _FACTORY_ADDRESS);
var INIT_CODE_HASH = '0x4a55f6be5820b2a28084af36ab76503fee78e9926d8499be2acd196517f462a4';
...
var WDEV = (_WDEV = {}, _WDEV[ChainId.MAINNET] = /*#__PURE__*/new Token(ChainId.MAINNET, '0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2', 18, 'WETH', 'Wrapped Ether'), _WDEV[ChainId.STANDALONE] = /*#__PURE__*/new Token(ChainId.STANDALONE, '0xC2Bf5F29a4384b1aB0C063e1c666f02121B6084a', 18, 'WDEV', 'Wrapped Dev'), _WDEV[ChainId.MOONROCK] = /*#__PURE__*/new Token(ChainId.MOONROCK, WETH, 18, 'WDEV', 'Wrapped Dev'), _WDEV[ChainId.MOONBASE] = /*#__PURE__*/new Token(ChainId.MOONBASE, WETH, 18, 'WDEV', 'Wrapped Dev'), _WDEV[ChainId.MOONSHADOW] = /*#__PURE__*/new Token(ChainId.MOONSHADOW, WETH, 18, 'WDEV', 'Wrapped Dev'), _WDEV);
...
var Route = /*#__PURE__*/function () {
  function Route(pairs, input, output) {
    ...
    !(input instanceof Token && pairs[0].involvesToken(input) || input === DEV && pairs[0].involvesToken(WDEV[pairs[0].chainId])) ? process.env.NODE_ENV !== "production" ? invariant(false, 'INPUT') : invariant(false) : void 0;
    !(typeof output === 'undefined' || output instanceof Token && pairs[pairs.length - 1].involvesToken(output) || output === DEV && pairs[pairs.length - 1].involvesToken(WDEV[pairs[0].chainId])) ? process.env.NODE_ENV !== "production" ? invariant(false, 'OUTPUT') : invariant(false) : void 0;
    var path = [input instanceof Token ? input : WDEV[pairs[0].chainId]];
...
var Trade = /*#__PURE__*/function () {
  function Trade(route, amount, tradeType) {
    ...
    this.inputAmount = tradeType === TradeType.EXACT_INPUT ? amount : route.input === DEV ? CurrencyAmount.ether(amounts[0].raw) : amounts[0];
    this.outputAmount = tradeType === TradeType.EXACT_OUTPUT ? amount : route.output === DEV ? CurrencyAmount.ether(amounts[amounts.length - 1].raw) : amounts[amounts.length - 1];
...
var Router = /*#__PURE__*/function () {
  ...
  Router.swapCallParameters = function swapCallParameters(trade, options) {
    var devIn = trade.inputAmount.currency === DEV;
    var devOut = trade.outputAmount.currency === DEV; // the router does not support both ether in and out

    !!(devIn && devOut) ? process.env.NODE_ENV !== "production" ? invariant(false, 'DEV_IN_OUT') : invariant(false) : void 0;
...
export { ChainId, Currency, CurrencyAmount, DEV, FACTORY_ADDRESS, Fetcher, Fraction, INIT_CODE_HASH, InsufficientInputAmountError, InsufficientReservesError, MINIMUM_LIQUIDITY, Pair, Percent, Price, Rounding, Route, Router, Token, TokenAmount, Trade, TradeType, WDEV, currencyEquals, inputOutputComparator, tradeComparator };
//# sourceMappingURL=moonbeamswap.esm.js.map
