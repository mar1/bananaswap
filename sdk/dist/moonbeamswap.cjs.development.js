...
var FACTORY_ADDRESS = (_FACTORY_ADDRESS = {}, _FACTORY_ADDRESS[exports.ChainId.STANDALONE] = '0x5c4242beB94dE30b922f57241f1D02f36e906915', _FACTORY_ADDRESS[exports.ChainId.MOONROCK] = factory, _FACTORY_ADDRESS[exports.ChainId.MOONBASE] = factory, _FACTORY_ADDRESS[exports.ChainId.MOONSHADOW] = factory, _FACTORY_ADDRESS);
...
var WDEV = (_WDEV = {}, _WDEV[exports.ChainId.MAINNET] = /*#__PURE__*/new Token(exports.ChainId.MAINNET, '0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2', 18, 'WETH', 'Wrapped Ether'), _WDEV[exports.ChainId.STANDALONE] = /*#__PURE__*/new Token(exports.ChainId.STANDALONE, '0xC2Bf5F29a4384b1aB0C063e1c666f02121B6084a', 18, 'WDEV', 'Wrapped Dev'), _WDEV[exports.ChainId.MOONROCK] = /*#__PURE__*/new Token(exports.ChainId.MOONROCK, WETH, 18, 'WDEV', 'Wrapped Dev'), _WDEV[exports.ChainId.MOONBASE] = /*#__PURE__*/new Token(exports.ChainId.MOONBASE, WETH, 18, 'WDEV', 'Wrapped Dev'), _WDEV[exports.ChainId.MOONSHADOW] = /*#__PURE__*/new Token(exports.ChainId.MOONSHADOW, WETH, 18, 'WDEV', 'Wrapped Dev'), _WDEV);
...
var Route = /*#__PURE__*/function () {
  function Route(pairs, input, output) {
    ...
    !(input instanceof Token && pairs[0].involvesToken(input) || input === DEV && pairs[0].involvesToken(WDEV[pairs[0].chainId])) ?  invariant(false, 'INPUT')  : void 0;
    !(typeof output === 'undefined' || output instanceof Token && pairs[pairs.length - 1].involvesToken(output) || output === DEV && pairs[pairs.length - 1].involvesToken(WDEV[pairs[0].chainId])) ?  invariant(false, 'OUTPUT')  : void 0;
...
var Trade = /*#__PURE__*/function () {
  function Trade(route, amount, tradeType) {
    ...
    this.inputAmount = tradeType === exports.TradeType.EXACT_INPUT ? amount : route.input === DEV ? CurrencyAmount.ether(amounts[0].raw) : amounts[0];
    this.outputAmount = tradeType === exports.TradeType.EXACT_OUTPUT ? amount : route.output === DEV ? CurrencyAmount.ether(amounts[amounts.length - 1].raw) : amounts[amounts.length - 1];
...
var Router = /*#__PURE__*/function () {
  ...
  Router.swapCallParameters = function swapCallParameters(trade, options) {
    ...
    !!(devIn && devOut) ?  invariant(false, 'DEV_IN_OUT')  : void 0;
...
//# sourceMappingURL=moonbeamswap.cjs.development.js.map
